import { _ as __exportAll, a as getVersionId, h as stegaClean, i as getVersionFromId, n as getDraftId, o as isDraftId, r as getPublishedId, s as isVersionId } from "./resolveEditInfo-Cz-smq3a-D70HoVoG.js";
import { t as isRecord } from "./isRecord-Kfmt-nk--QjzbOyHQ.js";
import { A as anySignal, C as createErrorClass, D as __spreadArray, E as __read, O as __values, S as arrRemove, T as __extends, _ as identity, a as defineRequester, b as EMPTY_SUBSCRIPTION, c as isHttpError$1, d as from, f as executeSchedule, g as Observable, h as operate, i as _defineProperty, k as isTimeoutError, l as isQueryParseError, m as createOperatorSubscriber, n as CorsOriginError, o as formatQueryParseError, p as innerFrom, r as ServerError, t as ClientError, v as SafeSubscriber, w as isFunction, x as Subscription, y as errorContext } from "./request-CYLhJzOA-7c1OIP_t.js";
...
//#endregion
//#region node_modules/@sanity/client/dist/config-CgJ16jET.js
...
var DEFAULT_MAX_BUFFER_SIZE = 104857600;
/**
...
var types_exports = /* @__PURE__ */ __exportAll({ possibleStoreRequestOptions: () => possibleStoreRequestOptions });
/** @internal */
...
function _fetch$2(client, httpRequest, _stega, query, _params = {}, options = {}) {
	...
	return stega.enabled ? Promise.all([request, import("./stegaEncodeSourceMap-Dj29aWKG-DkDyypd1.js").then((n) => n.n)]).then(([res, { stegaEncodeSourceMap }]) => {
...
var AssetsClient = class {
	...
	upload(assetType, body, options) {
		return lastValueFrom(_upload(_classPrivateFieldGet2(_client2$8, this), _classPrivateFieldGet2(_httpRequest3, this), assetType, body, options).pipe(filter((event) => event.type === "response"), map((event) => pluckUploadedAsset(event.body))));
	}
};
/**
...
function _upload(client, _httpRequest, assetType, body, opts = {}) {
	...
	return typeof XMLHttpRequest < "u" ? defer(async () => {
		let { uploadWithProgress } = await import("./browserUpload-BTQyjHMj-lKoHGlbN.js"), req = _prepareRequest(client, { ...baseRequest });
...
var defaultOptions = { includeResult: !0 };
/** @public */
...
async function _drainByCreatedAt(client, httpRequest, filter, params, options) {
	let all = [], cursor;
	for (;;) {
		let page = await lastValueFrom(_fetch(client, httpRequest, `*[${cursor ? `${filter} && (_createdAt > \$c || (_createdAt == \$c && _id > \$i))` : filter}] | order(_createdAt asc, _id asc) [0...200]`, cursor ? {
			...params,
			...cursor
		} : params, options));
...
//#endregion
export { BasePatch, BaseTransaction, ChannelError, ClientError, ConnectionFailedError, types_exports as Context, CorsOriginError, DisconnectError, EXPERIMENTAL_API_WARNING, MessageError, MessageParseError, ObservablePatch, ObservableSanityClient, ObservableTransaction, Patch, SanityClient, ServerError, Transaction, connectEventSource, createClient, deprecatedCreateClient as default, formatQueryParseError, isHttpError$1 as isHttpError, isQueryParseError, isTimeoutError, requester, validateApiPerspective };

import { t as isRecord$1 } from "./isRecord-Kfmt-nk--QjzbOyHQ.js";
...
function isHttpError$1(error) {
	if (!isRecord$1(error)) return !1;
	let response = error.response;
	return !(typeof error.statusCode != "number" || typeof error.message != "string" || !isRecord$1(response) || response.body === void 0 || typeof response.url != "string" || typeof response.method != "string" || typeof response.headers != "object" || typeof response.statusCode != "number");
}
/** @public */
...
function defineRequester(envOptions, config = {}) {
	let applyFetchInit = (opts, next) => {
		...
		let controller = new AbortController(), userSignal = options.signal, signal = userSignal ? anySignal([userSignal, controller.signal]) : controller.signal, subscription = from(promise({
			...options,
			signal
...
//#endregion
export { anySignal as A, createErrorClass as C, __spreadArray as D, __read as E, __values as O, arrRemove as S, __extends as T, identity as _, defineRequester as a, EMPTY_SUBSCRIPTION as b, isHttpError$1 as c, from as d, executeSchedule as f, Observable as g, operate as h, _defineProperty as i, isTimeoutError as k, isQueryParseError as l, createOperatorSubscriber as m, CorsOriginError as n, formatQueryParseError as o, innerFrom as p, ServerError as r, httpResponseFromFetch as s, ClientError as t, parseJsonText as u, SafeSubscriber as v, isFunction as w, Subscription as x, errorContext as y };
